            ...
            <div class="col-md-6">
                ...
                <form method="POST" action="{{ route('entreprises.update', $entreprise->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="nom" type="text" class="form-control" name="nom" value="{{$entreprise->nom}}">
                    </div>
                    <div class="form-group">
                        <label for="adresse">Adresse de l'entreprise</label><br>
                        <input id="adresse" type="text" class="form-control" name="adresse" value="{{$entreprise->adresse}}">
                    </div>
                    <div class="form-group">
                        <label for="telephone">Téléphone de l'entreprise</label><br>
                        <input id="telephone" type="text" class="form-control" name="telephone" value="{{$entreprise->telephone}}">
                    </div>
                    <div class="form-group">
                        <label for="mail">Mail de l'entreprise</label><br>
                        <input id="mail" type="text" class="form-control" name="mail" value="{{$entreprise->mail}}">
                    </div>
